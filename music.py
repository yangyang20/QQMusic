...
# 不同的歌手分类
singerClassify = {
    '内地' : 'getUCGI9519146579921814',
    '港台' : 'getUCGI016784581562988454',
    '欧美' : 'getUCGI5580211627006748',
    '日本' : 'getUCGI3536188118037513',
    '韩国' : 'getUCGI9533971737223138',
    '其他' : 'getUCGI09406099001281776'
}
...
def singerInformation(index):
    ...
    for page in range(1,5):
        url = 'https://u.y.qq.com/cgi-bin/musicu.fcg?callback=%s&g_tk=866772855&jsonpCallback=%s&loginUin=393622951&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0&data={"comm":{"ct":24,"cv":0},"singerList":{"module":"Music.SingerListServer","method":"get_singer_list",' \
            '"param":{"area":-100,"sex":-100,"genre":-100,"index":-100,"sin":%s,"cur_page":%s}}}' % (index,index,page*80-80,page)
        try:
            response = session.get(url=url,headers=headers)
